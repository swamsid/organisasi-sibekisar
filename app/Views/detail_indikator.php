        ...
        <div class="container">
            <div class="row" style="display: block;">
                <div class="card" id="divDataRekap">
                    <div class="card-body" >
                        <h4 class="card-title">Rangking Indikator <?php echo $label ?></h4>
                        <div class="row">
                            <div class="col-12 filter-layout">
                                    ...
                                    <form id="frmsearch" class="forms-sample form-horizontal">
                                        ...
                                        <div class="form-group">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-5 filter-aspek">
...
<script src="<?php echo base_url("assets/landing/js/detail_indikator2.js") ?>"></script>
