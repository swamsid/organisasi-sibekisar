...
<div class="content-wrapper" style="margin-top: -20px;">
    <div class="page-header">
        <h3 class="page-title"> 
            Form Koefisien <?php echo $tag == 'kab' ? 'Kabupaten/Kota' : 'Perangkat Daerah' ?>
        </h3>
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">
                    Koefisien <?php echo (isset($tag) ? 'Kab/Kota' : 'Perangkat Daerah') ?>
                </li>
            </ol>
        </nav>
    </div>
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th width="13%" class="text-center" style="font-weight: bold;">
                                                    Nilai Koefisien
                                                    <div style="font-size: 8pt; font-weight: normal; margin-top: 2px;">
                                                        (%)
                                                    </div>
                                                </th>
                                                <th width="24%" class="text-center" style="font-weight: bold;">
                                                    Catatan
                                                </th>
                                                <th width="13%" class="text-center" style="font-weight: bold;">
                                                    #
